-- Consultar a data e hora atuais usando as seguintes funções:
...
-- Outro ponto interessante, é que também podemos usar CURRENT_DATE() e NOW() em conjunto
-- com os comandos de manipulação de datas e tempo para encontrar resultados dinâmicos da seguinte maneira:
